...
class FirstTabFragment : Fragment(), KodeinAware {
    ...
    companion object {
        fun getInstance(): FirstTabFragment {
            val fragment =
                FirstTabFragment()
            val bundle = Bundle()
    ...
    private fun setUpRecyclerView() {
        ...
        adapterHorizontal = HorizontalCardsAdapter(cardsList, object : HorizontalCardsAdapter.ICardsItemSelected {
