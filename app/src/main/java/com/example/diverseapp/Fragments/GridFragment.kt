...
import com.example.diverseapp.Adapters.IsNotSelectedServiceGridAdapter
...
import kotlinx.android.synthetic.main.fragment_archived_tasks.*
...
class GridFragment : Fragment() {
    ...
    //Declare a variable for the selected items adapter for the recyclerview that doesn't contain an icon for each selected item
    private lateinit var isSelectedServiceAdapterWithoutIcon: IsSelectedServiceAdapterWithoutIcon

    //Declare a variable for the adapter for the grid recyclerview that contains the items that have not been selected yet
    private lateinit var isNotSelectedServiceGridAdapter: IsNotSelectedServiceGridAdapter
...
//        val suggestions = listOf("Apple", "Blueberry", "Carrot", "Daikon")
    ...
    private fun setRecyclerViews() {
        ...
        //Populate the arraylist of the grid recyclerview
        ...
        //Setup the adapter for the grid recyclerview
        isNotSelectedServiceGridAdapter = IsNotSelectedServiceGridAdapter(services)
        notSelectedGridRecyclerview?.layoutManager =
            GridLayoutManager(context, 2)
        notSelectedGridRecyclerview?.adapter = isNotSelectedServiceGridAdapter
        ...
        isNotSelectedServiceGridAdapter.setOnSettingSelectedListener(object :
            IsNotSelectedServiceGridAdapter.ISettingSelected {
            override fun onItemClicked(position: Int, service: Service) {
